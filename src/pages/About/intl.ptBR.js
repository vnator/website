const about_ptBR = {
  ...
  values: {
    title: 'Valores',
    paragraph:
      'Para nós o trabalho é uma aventura, durante esse desafio iremos aproveitar cada momento e faremos o possível pra chegar ao seu destino. Com esse intuito possuímos quatro pilares que sustentam nossas decisões, nossa disposição e inspiração para essa jornada.',
    quest: {
      title: 'Aventura',
      paragraph:
        'É aquilo que nos inspira, a emoção e excitação da descoberta, a ansiedade por criar ou transoformar as coisas. Somos Avidos por trabalhar com novas tecnologias ou aplicações, buscando novos enigmas e novas formas de desvenda-los, percorremos a estrada por que gostamos da aventura.',
    },
    onus: {
      title: 'Onus',
      paragraph:
