...
const IconEC2 = props => {
  ...
  return (
    <Svg {...props}>
      ...
      <path
        fill="#fff"
        d="M25.809 17.28h-2.133v-0.853h2.133v-10.24h-10.24v2.133h-0.853v-2.133c0-0.471 0.382-0.853 0.853-0.853v0h10.24c0.471 0 0.853 0.382 0.853 0.853v0 10.24c0 0.471-0.382 0.853-0.853 0.853v0z"></path>
      <path
        fill="#fff"
        d="M16.422 26.667h-10.24c-0.471 0-0.853-0.382-0.853-0.853v0-10.24c0-0.471 0.382-0.853 0.853-0.853v0h2.133v0.853h-2.133v10.24h10.24v-2.133h0.853v2.133c0 0.471-0.382 0.853-0.853 0.853v0z"></path>
      <path
        fill="#fff"
